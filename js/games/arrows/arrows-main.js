...
const LEVELS = [
  // Уровень 1 - простой (3x3)
  { size: 3, arrows: [[1, 0, 1], [2, 1, 2], [0, 2, 3]] }, // направления: 0=↑, 1=→, 2=↓, 3=←
  
  // Уровень 2 - средний (4x4)
  { size: 4, arrows: [[1, 0, 2, 1], [3, 2, 1, 0], [0, 1, 3, 2], [2, 3, 0, 1]] },
  
  // Уровень 3 - сложный (5x5)
  { size: 5, arrows: [[1, 0, 1, 2, 1], [3, 2, 1, 0, 2], [0, 1, 3, 1, 0], [2, 3, 0, 2, 3], [1, 0, 2, 1, 3]] },
];
